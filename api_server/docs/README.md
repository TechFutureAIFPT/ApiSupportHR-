...
flowchart LR
    ...
    subgraph BE["FastAPI Backend"]
        ...
        subgraph API["API Layer"]
            ...
            DEPS["deps.py<br/>Firebase Bearer token auth"]
        end
        ...
        subgraph DATA["Data / Integration Layer"]
            FBADM["integrations/firebase_admin.py"]
...
- Firebase được dùng cho xác thực và Firestore được dùng làm database chính.
...
flowchart TB
    ...
    subgraph STORAGE["Storage / Providers"]
        CFG["core/config.py"]
        FB2["integrations/firebase_admin.py"]
...
flowchart TD
    ...
    A2 --> A3["firebase_admin.verify_id_token()"]
...
- Mọi route account quan trọng đều đi qua `deps.py` để xác thực Firebase token.
